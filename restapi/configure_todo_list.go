...
import (
	...
	"swaggertryouts/restapi/operations"
	"swaggertryouts/restapi/operations/todos"
)

//go:generate swagger generate server --target ..\..\swaggertryouts --name TodoList --spec ..\swagger.yml --principal interface{}
